        ...
        if (this.checked) {
            //if ($("#PricingMethod_1").val() != "") {
                ...
                if ($("#PricingMethod_3").val() == "Disc") {
                    ...
                    $("#txtValue_3_5").val($("#txtValue_1_5").val());
                }
            //}
            ...
            //if ($("#PricingMethod_2").val() != "") {
                ...
                if ($("#PricingMethod_4").val() == "Disc") {
                    ...
                    $("#txtValue_4_5").val($("#txtValue_2_5").val());
                }
            //}
...
function HTML_CREATE(
    ...
    PricingMethod_3, PricingSign_3, txtDisc_3_1, txtValue_3_1, txtValue_3_2, txtValue_3_3, txtValue_3_4, txtValue_3_5,
    Chk_Speci_Additional_2, txtFromDate1, txtToDate1,
    PricingMethod_4, PricingSign_4, txtDisc_4_1, txtValue_4_1, txtValue_4_2, txtValue_4_3, txtValue_4_4, txtValue_4_5,
    new_id) {
    ...
    html += "<td style='display:none;'><span class='Fi-Criteria txtValue_3_5'>" + txtValue_3_5 + "</span></td>";
    ...
    html += "<td style='display:none;'><span class='Fi-Criteria txtValue_4_5'>" + txtValue_4_5 + "</span></td>";
    ...
    if (PricingMethod_3 == "Disc") {
        html += (txtDisc_3_1 == "" && txtDisc_3_1 != "0" ? '<span class="Fi-Criteria _txtDisc_3_1" style="border: 1px solid #003d66;padding: 3px 4px 3px 4px;margin: 0px 3px 0px 0px;">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</span>' : '<span class="Fi-Criteria _txtDisc_3_1" style="border: 1px solid #003d66;padding: 3px 4px 3px 4px;margin: 0px 3px 0px 0px;">' + txtDisc_3_1 + '</span>');
    }
    else if (PricingMethod_3 == "Value") {
        html += (txtValue_3_1 == "" && txtValue_3_1 != "0" ? '<span class="Fi-Criteria _txtValue_3_1" style="border: 1px solid #003d66;padding: 3px 4px 3px 4px;margin: 0px 3px 0px 0px;">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</span>' : '<span class="Fi-Criteria _txtValue_3_1" style="border: 1px solid #003d66;padding: 3px 4px 3px 4px;margin: 0px 3px 0px 0px;">' + txtValue_3_1 + '</span>');
        html += (txtValue_3_2 == "" && txtValue_3_2 != "0" ? '<span class="Fi-Criteria _txtValue_3_2" style="border: 1px solid #003d66;padding: 3px 4px 3px 4px;margin: 0px 3px 0px 0px;">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</span>' : '<span class="Fi-Criteria _txtValue_3_2" style="border: 1px solid #003d66;padding: 3px 4px 3px 4px;margin: 0px 3px 0px 0px;">' + txtValue_3_2 + '</span>');
        html += (txtValue_3_3 == "" && txtValue_3_3 != "0" ? '<span class="Fi-Criteria _txtValue_3_3" style="border: 1px solid #003d66;padding: 3px 4px 3px 4px;margin: 0px 3px 0px 0px;">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</span>' : '<span class="Fi-Criteria _txtValue_3_3" style="border: 1px solid #003d66;padding: 3px 4px 3px 4px;margin: 0px 3px 0px 0px;">' + txtValue_3_3 + '</span>');
        html += (txtValue_3_4 == "" && txtValue_3_4 != "0" ? '<span class="Fi-Criteria _txtValue_3_4" style="border: 1px solid #003d66;padding: 3px 4px 3px 4px;margin: 0px 3px 0px 0px;">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</span>' : '<span class="Fi-Criteria _txtValue_3_4" style="border: 1px solid #003d66;padding: 3px 4px 3px 4px;margin: 0px 3px 0px 0px;">' + txtValue_3_4 + '</span>');
        html += (txtValue_3_5 == "" && txtValue_3_5 != "0" ? '<span class="Fi-Criteria _txtValue_3_5" style="border: 1px solid #003d66;padding: 3px 4px 3px 4px;margin: 0px 3px 0px 0px;">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</span>' : '<span class="Fi-Criteria _txtValue_3_5" style="border: 1px solid #003d66;padding: 3px 4px 3px 4px;margin: 0px 3px 0px 0px;">' + txtValue_3_5 + '</span>');
    }
    html += "</div>";
    html += "</td>";
    ...
    if (PricingMethod_4 == "Disc") {
        html += (txtDisc_4_1 == "" && txtDisc_4_1 != "0" ? '<span class="Fi-Criteria _txtDisc_4_1" style="border: 1px solid #003d66;padding: 3px 4px 3px 4px;margin: 0px 3px 0px 0px;">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</span>' : '<span class="Fi-Criteria _txtDisc_4_1" style="border: 1px solid #003d66;padding: 3px 4px 3px 4px;margin: 0px 3px 0px 0px;">' + txtDisc_4_1 + '</span>');
    }
    else if (PricingMethod_4 == "Value") {
        html += (txtValue_4_1 == "" && txtValue_4_1 != "0" ? '<span class="Fi-Criteria _txtValue_4_1" style="border: 1px solid #003d66;padding: 3px 4px 3px 4px;margin: 0px 3px 0px 0px;">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</span>' : '<span class="Fi-Criteria _txtValue_4_1" style="border: 1px solid #003d66;padding: 3px 4px 3px 4px;margin: 0px 3px 0px 0px;">' + txtValue_4_1 + '</span>');
        html += (txtValue_4_2 == "" && txtValue_4_2 != "0" ? '<span class="Fi-Criteria _txtValue_4_2" style="border: 1px solid #003d66;padding: 3px 4px 3px 4px;margin: 0px 3px 0px 0px;">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</span>' : '<span class="Fi-Criteria _txtValue_4_2" style="border: 1px solid #003d66;padding: 3px 4px 3px 4px;margin: 0px 3px 0px 0px;">' + txtValue_4_2 + '</span>');
        html += (txtValue_4_3 == "" && txtValue_4_3 != "0" ? '<span class="Fi-Criteria _txtValue_4_3" style="border: 1px solid #003d66;padding: 3px 4px 3px 4px;margin: 0px 3px 0px 0px;">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</span>' : '<span class="Fi-Criteria _txtValue_4_3" style="border: 1px solid #003d66;padding: 3px 4px 3px 4px;margin: 0px 3px 0px 0px;">' + txtValue_4_3 + '</span>');
        html += (txtValue_4_4 == "" && txtValue_4_4 != "0" ? '<span class="Fi-Criteria _txtValue_4_4" style="border: 1px solid #003d66;padding: 3px 4px 3px 4px;margin: 0px 3px 0px 0px;">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</span>' : '<span class="Fi-Criteria _txtValue_4_4" style="border: 1px solid #003d66;padding: 3px 4px 3px 4px;margin: 0px 3px 0px 0px;">' + txtValue_4_4 + '</span>');
        html += (txtValue_4_5 == "" && txtValue_4_5 != "0" ? '<span class="Fi-Criteria _txtValue_4_5" style="border: 1px solid #003d66;padding: 3px 4px 3px 4px;margin: 0px 3px 0px 0px;">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</span>' : '<span class="Fi-Criteria _txtValue_4_5" style="border: 1px solid #003d66;padding: 3px 4px 3px 4px;margin: 0px 3px 0px 0px;">' + txtValue_4_5 + '</span>');
    }
    html += "</div>";
    html += "</td>";
...
var GetError = function () {
    ...
    if ($("#PricingMethod_1").val() == "") {
        ErrorMsg.push({
            'Error': "Please Select SUPPLIER COST DISC > COMMON DISC > Price Method.",
        });
    }
    else {
        if ($("#PricingMethod_1").val() == "Disc") {
            if ($("#txtDisc_1_1").val() == "") {
                ErrorMsg.push({
                    'Error': "Please Enter SUPPLIER COST DISC > COMMON DISC > Discount.",
                });
            }
        }
            ...
            if ($("#txtValue_1_1").val() == "" && $("#txtValue_1_2").val() == "" && $("#txtValue_1_3").val() == "" && $("#txtValue_1_4").val() == "" && $("#txtValue_1_5").val() == "") {
                ErrorMsg.push({
                    'Error': "Please Enter SUPPLIER COST DISC > COMMON DISC > Value.",
                });
            }
        }
    }
    if (document.getElementById("Chk_Speci_Additional_1").checked == true) {
        if ($("#PricingMethod_2").val() == "") {
            ErrorMsg.push({
                'Error': "Please Select SUPPLIER COST DISC > SPECIAL DISC > Price Method.",
            });
        }
    }
    ...
    if ($("#PricingMethod_2").val() != "") {
        if ($("#PricingMethod_2").val() == "Disc") {
            if ($("#txtDisc_2_1").val() == "") {
                ErrorMsg.push({
                    'Error': "Please Enter SUPPLIER COST DISC > SPECIAL DISC > Discount.",
                });
            }
        }
            ...
            if ($("#txtValue_2_1").val() == "" && $("#txtValue_2_2").val() == "" && $("#txtValue_2_3").val() == "" && $("#txtValue_2_4").val() == "" && $("#txtValue_2_5").val() == "") {
                ErrorMsg.push({
                    'Error': "Please Enter SUPPLIER COST DISC > SPECIAL DISC > Value.",
                });
            }
        }
    }
    ...
    if ($("#PricingMethod_3").val() == "") {
        ...
        if ($("#PricingMethod_3").val() == "Disc") {
            ...
            if ($("#txtValue_3_1").val() == "" && $("#txtValue_3_2").val() == "" && $("#txtValue_3_3").val() == "" && $("#txtValue_3_4").val() == "" && $("#txtValue_3_5").val() == "") {
                ErrorMsg.push({
    ...
    if ($("#PricingMethod_4").val() != "") {
        if ($("#PricingMethod_4").val() == "Disc") {
            ...
            if ($("#txtValue_4_1").val() == "" && $("#txtValue_4_2").val() == "" && $("#txtValue_4_3").val() == "" && $("#txtValue_4_4").val() == "" && $("#txtValue_4_5").val() == "") {
                ErrorMsg.push({
...
var AddNewRow = function () {
    if (EditCriteria_UniqueId == "") {
        ...
        if (ErrorMsg.length > 0) {
            ...
            var txtValue_3_5 = NullReplaceDecimal4ToFixed($("#txtValue_3_5").val());
            ...
            var txtValue_4_5 = NullReplaceDecimal4ToFixed($("#txtValue_4_5").val());
    ...
    if (ErrorMsg.length > 0) {
        ...
        $("#tblFilters #tblBodyFilters tr").each(function () {
            if ($(this).find('.hdn_UniqueId').val() == EditCriteria_UniqueId) {
                ...
                $(this).find('.txtValue_3_5').html(txtValue_3_5);
                ...
                $(this).find('.txtValue_4_5').html(txtValue_4_5);
    ...
    setTimeout(function () {
        ...
        $("#tblFilters #tblBodyFilters tr").each(function () {
            ...
            if ($(this).find('.hdn_UniqueId').val() == EditCriteria_UniqueId) {
                ...
                var txtValue_3_5 = NullReplaceDecimal4ToFixed($(this).find('.txtValue_3_5').html());
                ...
                var txtValue_4_5 = NullReplaceDecimal4ToFixed($(this).find('.txtValue_4_5').html());
    ...
    if (ErrorMsg.length > 0) {
        ...
        $("#tblFilters #tblBodyFilters tr").each(function () {
            list.push({
                ...
                Value_3_5: $(this).find('.txtValue_3_5').html(),
                ...
                Value_4_5: $(this).find('.txtValue_4_5').html()
            });
        });
        ...
        loaderShow();
        $.ajax({
            url: '/User/AddUpdate_Supplier_Disc',
            type: "POST",
            data: { req: obj },
            ...
            success: function (data) {
                if (data.Status == "1" && data.Data.length > 0) {
                    ...
                    $.each(data.Data, function (i, itm) {
                        ...
                        var txtValue_3_5 = NullReplaceDecimal4ToFixed(itm.Value_3_5);
                        ...
                        var txtValue_4_5 = NullReplaceDecimal4ToFixed(itm.Value_4_5);
                        ...
                        html += HTML_CREATE(Location, Shape, Carat, Color_Type, Color, F_INTENSITY, F_OVERTONE, F_FANCY_COLOR, MixColor, Clarity, Cut, Polish, Sym, Fls, Lab, FromLength, ToLength,
                            ...
                            txtValue_4_2, txtValue_4_3, txtValue_4_4, txtValue_4_5, new_id);
                    });
